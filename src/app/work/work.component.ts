...
export class WorkComponent implements OnInit {
  ...
  public setProjects() {
      const Irctc = new Project(
      1,
      'Irctc',
      'There are user java with angular',
      [Languages.Java, Languages.Angular, Languages.MYSQL],
  ...
  public setLanguages() {
    const typescript = new Language(
      1,
      Languages.Java,
      'https://icons8.com/icon/lTKW3iI3wIT0/java',
    ...
    const ionic = new Language(
      3,
      Languages.Flutter,
      'https://img.icons8.com/?size=100&id=IYQQHplg11Ie&format=png&color=000000',
      'I use it in my work-study projects.',
      LanguagesLevel.Advanced
    );
